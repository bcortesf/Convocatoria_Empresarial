...
import com.bryancfz.wishlist.apirest.models.services.IClienteService;
...
public class ClienteRestController {
	...
	@GetMapping("/cliente/showAll")
	@ResponseStatus(code = HttpStatus.OK)
	public ResponseEntity<?> showAll() {
		List<Cliente> lista;
		try {
			lista = clienteService.findAll_();	
			this.okResponse.setPropertiesHashMap("ok", lista);			
		} catch (DataAccessException e) {
			this.errorResponse.setPropertiesHashMap("No se puede consultar la lista de clientes", e, HttpStatus.NOT_FOUND);
